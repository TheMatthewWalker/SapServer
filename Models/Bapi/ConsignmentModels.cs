...
/// <summary>One consignment goods-receipt line (MSEG BWART=101/SOBKZ=K, joined to MKPF).</summary>
public sealed class ConsignmentGrRow
{
    ...
    public decimal Quantity         { get; init; }                  // MSEG-MENGE
    ...
    public string  InvoiceNumber    { get; init; } = string.Empty; // MKPF-LFBNR (vendor delivery note ref)
}
